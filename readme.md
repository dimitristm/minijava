...
we use the visitor pattern to explore the syntax tree. We also calculate the offsets of the fields and the vtable.

## Building
cd into the directory with the makefile and run `make`.
